        ...
        <tbody>
          <tr v-for="reservation in reservations" :key="reservation.id">
            ...
            <td class="border border-gray-300 px-4 py-2 flex gap-2">
              <button @click="editReservation(reservation)" class="bg-blue-500 text-white px-2 py-1 rounded">✏️</button>
              <button @click="deleteReservation(reservation.id)" class="bg-red-500 text-white px-2 py-1 rounded">🗑️</button>
            </td>
          </tr>
        </tbody>
      </table>
